namespace MyReadOnly.IntegrationTests.EntityFrameworkTests
{
    using System.Linq;
    ...
    public sealed class CustomerRepositoryTests
    {
        ...
        {
            var options = new DbContextOptionsBuilder<MyReadOnlyContext>()
            ...
            using(var context = new MyReadOnlyContext(options))
            {
