namespace HexagonalBasicWithoutInfraProject.UI.UseCases.GetCustomerDetails
{
    using HexagonalBasicWithoutInfraProject.Application;
    using HexagonalBasicWithoutInfraProject.Application.UseCases.GetCustomerDetails;
