namespace EventSourcingEmptyProject.Infrastructure.ServiceBus
{
    using Confluent.Kafka;
    using Confluent.Kafka.Serialization;
    using EventSourcingEmptyProject.Application.ServiceBus;
        ...
        public void Listen()
        {
            using (var consumer = new Consumer<string, string>(constructConfig(brokerList, true), new StringDeserializer(Encoding.UTF8), new StringDeserializer(Encoding.UTF8)))
            {
                    ...
                    =>
                {
                    ...
                    catch (EventSourcingEmptyProjectException ex)
                    {
