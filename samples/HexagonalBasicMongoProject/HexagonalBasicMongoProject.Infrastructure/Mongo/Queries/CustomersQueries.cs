namespace HexagonalBasicMongoProject.Infrastructure.Mongo.Queries
{
    ...
    using HexagonalBasicMongoProject.Application;
    ...
    public class CustomersQueries : ICustomersQueries
    {
        ...
        public CustomersQueries(MongoContext mongoDB, IResultConverter resultConverter)
        {
