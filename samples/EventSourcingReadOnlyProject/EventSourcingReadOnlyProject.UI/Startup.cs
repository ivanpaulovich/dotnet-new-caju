namespace EventSourcingReadOnlyProject.UI
{
    using Autofac;
    using EventSourcingReadOnlyProject.UI.Filters;
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                options.IncludeXmlComments(
                    Path.ChangeExtension(
                        Assembly.GetAssembly(typeof(EventSourcingReadOnlyProject.UI.Startup)).Location,
                        "xml"));
