namespace EventSourcingBasicProject.UI
{
    using Autofac;
    using EventSourcingBasicProject.UI.Filters;
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                options.IncludeXmlComments(
                    Path.ChangeExtension(
                        Assembly.GetAssembly(typeof(EventSourcingBasicProject.UI.Startup)).Location,
                        "xml"));
