namespace EventSourcingFullProject.UI
{
    using Autofac;
    using EventSourcingFullProject.UI.Filters;
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                options.IncludeXmlComments(
                    Path.ChangeExtension(
                        Assembly.GetAssembly(typeof(EventSourcingFullProject.UI.Startup)).Location,
                        "xml"));
